...
INSERT INTO products(id, name, price, imgSrc, itemType, colour, inCart, stock) VALUES
    ...
    (8, 'Singapore-Set', 50, './images/item8.jpg', 'set', 'Mutli', 0, 7), 
    (9, 'New-York-Set', 50, './images/item9.jpg', 'set', 'Multi', 0, 9), 
    (10, 'Paris-Set', 50, './images/item10.jpg', 'set', 'Multi', 0, 50), 
    (11, 'London-Set', 50, './images/item11.jpg', 'set', 'Multi', 0, 50), 
    (12, 'Taj-Mahal', 50, './images/item12.jpg', 'set', 'Multi', 0, 50), 
    (13, 'Colosseum', 50, './images/item13.jpg', 'set', 'Multi', 0, 50),
    (14, 'Owl-Set', 10, './images/item14.jpg', 'set', 'Multi', 0, 50),
    (15, 'Dog-Set', 10, './images/item15.jpg', 'set', 'Multi', 0, 50),
    (16, 'Tuktuk', 25, './images/item16.jpg', 'set', 'Multi', 0, 50),
    (17, 'Taxi', 25, './images/item17.jpg', 'set', 'Multi', 0, 50);
